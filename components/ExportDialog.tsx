          ...
          printWindow.document.write(`
            ...
            <body>
              <div class="page-header">
                <div class="logo">RESONANCE LAB</div>
              </div>
              ...
              <div class="page-footer">Generated by Resonance Lab</div>
            </body>
            </html>
          `);
          ...
          <body>
            <div class="Section1">
              ...
              <div style="mso-element:header" id="h1">
                <p class="header">RESONANCE LAB</p>
              </div>
              ...
              <div style="mso-element:footer" id="f1">
                <p class="footer">Generated by Resonance Lab</p>
              </div>
            </div>
          </body>
          </html>
